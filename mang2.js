...
function phanTich1YeuTo(hao, chiTime, isThang) {
    ...
    // BỔ SUNG: Hào trùng với Ngày/Tháng gọi là Nhật kiến / Nguyệt kiến -> Cực Vượng
    if (hao.chi === chiTime) {
        let kienLabel = isThang ? "Nguyệt kiến" : "Nhật kiến";
        return { score: 2, reason: `Lâm <b>${kienLabel}</b> (Trùng với ${timeLabel}) → <span style="color:var(--red)">Vượng</span>` };
    }
