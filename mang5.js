...
function phanTichChuDeChuyenSauKhac(cd, dt, dtHao, theHao, ungHao, listNT, listKT, dongArrList) {
    ...
    switch (cd) {
        case 'cau_tai': 
            ...
            else if (quan && quan.i === theHao.i && tai && tai.dong && NH_SINH[tai.nh] === theNh) res += `<li><b>🟢 Quan trì Thế, Tài động sinh Thế:</b> Cầu tài dễ dàng (dựa vào chức vụ, quản lý để ra tiền).</li>`;
            ...
            if (quan && quan.dong && quan.ltt === 'Huyền Vũ' && NH_KHAC[quan.nh] === theNh) {
                res += `<li><b>⚠️ Kinh doanh tạm thời/Môi giới:</b> Quan Quỷ phát động lâm Huyền Vũ khắc Thế → Đề phòng bị người môi giới lừa đảo, mất tiền oang!</li>`;
            }
