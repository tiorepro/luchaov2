...
/* =========================================
   ...
   (Dữ liệu Phong thủy đã được load từ core.js)
========================================= */
...
function phanTichChuDeChuyenSauKhac(cd, dt, dtHao, theHao, ungHao, listNT, listKT, dongArrList) {
    ...
    switch (cd) {
        case 'cau_tai': 
            ...
            if (huynh && huynh.dong) res += `<span class="color-bad">Huynh động thì chi phí cao, cướp tài, cạnh tranh khốc liệt.</span>`;
            ...
            if (theBiHinhKhac) res += `<li><b>🎲 Cờ bạc/Đầu cơ rủi ro:</b> Thế gặp Hình/Khắc từ Nhật/Nguyệt/Động → Đánh bạc, đầu cơ chắc chắn sẽ thua.</li>`;
