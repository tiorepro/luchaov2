...
/* =========================================
   ...
   (Hoàn toàn không khai báo lại hằng số ở đây)
========================================= */
...
function phanTichChuDeChuyenSauKhac(cd, dt, dtHao, theHao, ungHao, listNT, listKT, dongArrList) {
    ...
    switch (cd) {
        case 'cau_tai': 
            ...
            if(!quan) res += `<li><b>⚠️ 9. Không Quỷ tranh giành:</b> Quẻ không có Quan Quỷ, Kỵ thần (Huynh đệ) lộng hành không bị chế ngự. Nếu Kỵ thần gặp nhiều sẽ vây hãm cướp tài.</li>`;
            ...
            if (tai) {
                ...
                if (phucHao) {
                    let phiHao = dt.haoData[phucHao.i]; 
